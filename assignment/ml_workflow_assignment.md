...
2. #### Exploratory Data Analysis (EDA) — EDA is essential to understand data distributions, detect missing values, identify outliers, and uncover relationships between features and the target variable, which guides feature selection and preprocessing.
